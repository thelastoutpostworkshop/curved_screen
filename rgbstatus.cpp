...
void turnBuiltInLEDBlue(uint8_t brightness)
{
    neopixelWrite(RGB_BUILTIN, 0, 0, brightness);
}
void turnBuiltInLEDGreen(uint8_t brightness)
{
    neopixelWrite(RGB_BUILTIN, 0, brightness, 0);
}
void turnBuiltInLEDCyan(uint8_t brightness)
{
    neopixelWrite(RGB_BUILTIN, 0, brightness, brightness);
}
void turnBuiltInLEDYellow(uint8_t brightness)
{
    neopixelWrite(RGB_BUILTIN, brightness, brightness, 0);
}
void turnBuiltInLEDRed(uint8_t brightness)
{
